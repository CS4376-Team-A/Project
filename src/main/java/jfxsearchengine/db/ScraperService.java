...
public class ScraperService implements IScraperService{
    ...
    private void scrape(String url, int maxDepth, int currentDepth) {
        ...
        try {
            ...
            //String keywords = extractMetaData(document, "keywords"); //this doesnt work lol keywords will be filled in elsewhere
            System.out.println("URL: " + url);
            System.out.println("Title: " + title);
            System.out.println("Description: " + description);
            //System.out.println("Keywords: " + keywords);
            Index index = new Index(url, title, description, new String[0]); 
            db.saveIndex(index);
